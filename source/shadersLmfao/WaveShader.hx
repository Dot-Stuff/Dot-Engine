...
class WaveShader
{
	...
	public var effectType(default, set):WaveShaderType = DREAMY;
	public var waveSpeed(default, set):Float = 1;
	...
	function set_effectType(v:WaveShaderType):WaveShaderType
	{
		effectType = v;
		shader.effectType.value = [WaveShaderType.getConstructors().indexOf(Std.string(v))];
		return v;
	}
